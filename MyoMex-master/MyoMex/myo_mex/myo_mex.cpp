...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
 ...
 //status is used to determine the initialization
    ...
    if ( !mexIsLocked())
      mexErrMsgTxt("myo_mex is not initialized.1\n");
    if ( runThreadFlag )
      mexErrMsgTxt("myo_mex is already streaming.1\n");
    if ( nlhs>0 )
      mexErrMsgTxt("myo_mex too many outputs specified.1\n");
    ...
    if ( !runThreadFlag )
      mexErrMsgTxt("myo_mex is not streaming.2\n");
    if ( nlhs>1 )
      mexErrMsgTxt("myo_mex too many outputs specified.2\n");
    ...
    if ( !mexIsLocked() )
      mexErrMsgTxt("myo_mex is not initialized3.\n");
    if ( !runThreadFlag )
      mexErrMsgTxt("myo_mex is not streaming3.\n");
    if ( nlhs>0 )
      mexErrMsgTxt("myo_mex too many outputs specified3.\n");
    ...
    if ( nlhs>0 )
      mexErrMsgTxt("myo_mex too many outputs specified4.\n");
